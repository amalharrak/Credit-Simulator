...
<div class="d-flex justify-content-center h-100">
		...
		<div class="card">
				...
				<div class="wrap-login100">
			      <ul class="nav">
					<span>	<li><center><a class="active" href=""><i>Annuitée</i></a></center></li></span>
					<span><li><center><a href="capitalcredit.jsp"><i>Capital</i></a></center></li></span>
					<span><li><center><a href="dureecredit.jsp"><i>Durée</i></a></center></li></span>
				</ul>
				</div>
			</div>
			
	<div class="card-body">
		<form class="login100-form validate-form"  method="post" action="${pageContext.request.contextPath}/RecoverServ">
			 <span class="login100-form-title"><center><b> <i>Calculer Annuitée </i></b></center> </span>
			 <br/>
				<div class="input-group form-group" data-validate="Duree is required">
				<div class="input-group-prepend">
	<span class="input-group-text"> <i class="fa fa-clock-o"  aria-hidden="true"></i>
						</span></div>
						<input class="form-control" type="number" min="1" name="duree"
							placeholder="durée emprunt" required  value=${duree}>
					</div>
					
			
				<div class="input-group form-group" data-validate="Montant is required">
				<div class="input-group-prepend">
				<span class="input-group-text"> <i class="fa fa-usd" aria-hidden="true"></i>
						</span></div>
		     	<input class="form-control" type="number" step="any" min="0" name="montant" 
			             placeholder="montant" required  value=${montant}> 
					</div>
	     ...
	     <span class="input-group-text"> <i class="fa fa-percent" aria-hidden="true"></i>
			...
			<input class="form-control" type="number" step="any" name="taux"
							placeholder=" taux annuel" required  value=${taux}>
					</div>
		
				
					<div class="form-group">
						<input type="submit" value="Calculer"  name="calculm" class="btn float-center login_btn">
					</div>
					...
					<div class="text-center p-t-12">
						<span class="txt1"> </span> <a class="txt2" href="#"><i> Annuité
							égale</i>
							<h1>${mensualite}</h1>
						</a>
					</div>
			 ...
			 <footer class="footer">© 2020 IAO-Crédit by Amal Harrak</footer>
	</div>
</div>
