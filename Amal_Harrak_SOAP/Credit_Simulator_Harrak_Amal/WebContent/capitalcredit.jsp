...
<div class="d-flex justify-content-center h-100">
			...
			<div class="card-header">
				...
				<div class="wrap-login100">
			      <ul class="nav">
					...
					<span><li><center><a class="active" href="capitalcredit.jsp"><i>Capital</i></a></center></li></span>
	...
	<div class="card-body">
		<form class="login100-form validate-form"  method="post" action="CapitalServ" >
			 <span class="login100-form-title"><center><b> <i>Calculer Capital </i></b></center> </span>
			 <br/>
				...
				<span class="input-group-text"> <i class="fa fa-clock-o" aria-hidden="true"></i>
		     	...
		     	<input class="form-control" type="number" required  min="1" name="dureecap" placeholder="durée emprunt" value=${dureecap}> 
					</div>
	...
	<span class="input-group-text"> <i class=" fa fa-usd"  aria-hidden="true"></i>
						...
						<input class="form-control" type="number"  required step="any" min="1" name="annuitecap" placeholder="annuite" value=${annuite} >
					</div>
	     ...
	     <span class="input-group-text"> <i class="fa fa-percent" aria-hidden="true"></i>
			...
			<input class="form-control" type="number" step="any" 
							 required  min="0" name="tauxcap" placeholder="taux annuel " value= ${tauxcap}>
					</div>
		
				
					<div class="form-group">
						<input type="submit" value="Calculer" name="calculc" class="btn float-center login_btn">
					</div>
					...
					<div class="container-login100-form-btn">
						<button style="background-color: #ff7069;"
							class="login100-form-btn" type="submit" name="savecapital">
